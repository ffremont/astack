...
import com.github.ffremont.astack.service.model.MoonPhase;
...
public class MoonService {
    ...
    //27 jours 7 heures 43
		/*var newMoonRef = LocalDate.of(2023, Month.APRIL, 20)
				;//age 0

		var date = ChronoUnit.DAYS.between(newMoonRef, LocalDate.now());
